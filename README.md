...
This repo is a fork from [AriaNg](https://github.com/mayswind/AriaNg)
## Introduction
...
## Installation
Support only Linux, check release page, download chmod and run.

## More info plz check origin [repo](https://github.com/mayswind/AriaNg)
